...
The scripts mentioned below can be run in a docker image ```keng404/nextflow-to-icav2-config:0.0.7a```
...
```bash
docker run -itv `pwd`:`pwd` keng404/nextflow-to-icav2-config:0.0.7a /bin/bash
```
